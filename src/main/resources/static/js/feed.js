...
const feedObj = {
    ...
    makeFeedList: function(data) {
        ...
        for(let i=0; i<data.length; i++) {
            ...
            const delCmtSpan = document.createElement('span');
            ...
            if (item.cmt != null && item.cmt.isMore === 1) {
                ...
                moreCmtSpan.addEventListener('click', () => {
                    ...
                    delCmtSpan.className = 'pointer';
                    delCmtSpan.innerText = '댓글 닫기';
                ...
                delCmtSpan.addEventListener('click', () => {
                    cmtListDiv.innerHTML = '';
                    moreCmtSpan.classList.remove('hide');
                    delCmtSpan.classList.add('hide');
